...
std::string topicListRequestToJson(const cli::TopicListSrv::Request& request, std::uint8_t timeout_sec);

/// @brief Serialize a ROS service request as a LiveKit RPC JSON payload.
/// @param request ROS service request.
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string topicPubRequestToJson(const cli::TopicPubSrv::Request& request, std::uint8_t timeout_sec);

/// @brief Serialize a ROS service request as a LiveKit RPC JSON payload.
/// @param request ROS service request.
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string serviceListRequestToJson(const cli::ServiceListSrv::Request& request, std::uint8_t timeout_sec);
...
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string serviceCallRequestToJson(const cli::ServiceCallSrv::Request& request, std::uint8_t timeout_sec);

/// @brief Serialize a ROS service request as a LiveKit RPC JSON payload.
/// @param request ROS service request.
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string interfaceShowRequestToJson(const cli::InterfaceShowSrv::Request& request, std::uint8_t timeout_sec);
