...
using InterfaceShowSrv = ros2_livekit_bridge_msgs::srv::Ros2InterfaceShow;
//! @brief Generated ROS service type for remote `ros2 topic list` requests.
using TopicListSrv = ros2_livekit_bridge_msgs::srv::Ros2TopicList;
//! @brief Generated ROS service type for remote `ros2 topic pub` requests.
using TopicPubSrv = ros2_livekit_bridge_msgs::srv::Ros2TopicPub;
//! @brief Generated ROS service type for remote `ros2 service list` requests.
using ServiceListSrv = ros2_livekit_bridge_msgs::srv::Ros2ServiceList;
/// @brief Generated ROS service type for remote `ros2 service call` requests.
using ServiceCallSrv = ros2_livekit_bridge_msgs::srv::Ros2ServiceCall;
