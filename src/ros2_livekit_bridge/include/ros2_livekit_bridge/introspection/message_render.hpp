...
void renderMessage(std::ostringstream &stream, const introspection::MessageMembers &members, const void *message,
...
/// @param indent Current indentation depth in spaces.
void renderNestedMessage(std::ostringstream &stream, const introspection::MessageMember &member,
...
void renderMessageArrayItem(std::ostringstream &stream, const introspection::MessageMembers &members,
...
/// @param indent Current indentation depth in spaces.
void renderSingleField(std::ostringstream &stream, const introspection::MessageMember &member, const void *field_memory,
                       std::size_t indent);
...
/// @param indent Current indentation depth in spaces.
void renderArrayField(std::ostringstream &stream, const introspection::MessageMember &member, const void *field_memory,
                      std::size_t indent);
...
/// @param field_memory Pointer to the field memory.
/// @param indent Current indentation depth in spaces.
void renderField(std::ostringstream &stream, const introspection::MessageMember &member, const void *field_memory,
                 std::size_t indent);
