...
TopicListOptions topicListOptionsFromRequest(const ros2_cli::Ros2TopicList::Request& request);

/// @brief Convert a ROS service request to local topic-pub options.
/// @param request ROS service request.
/// @return Topic-pub options from the request fields.
TopicPubOptions topicPubOptionsFromRequest(const ros2_cli::Ros2TopicPubSrv::Request& request);

/// @brief Convert a ROS service request to local service-list options.
/// @param request ROS service request.
/// @return Service-list options from the request flags.
ServiceListOptions serviceListOptionsFromRequest(const ros2_cli::Ros2ServiceList::Request& request);

/// @brief Convert a ROS service request to local service-call options.
/// @param request ROS service request.
/// @return Service-call options from the request fields.
ServiceCallOptions serviceCallOptionsFromRequest(const ros2_cli::Ros2ServiceCallSrv::Request& request);

/// @brief Convert a ROS service request to local interface-show options.
/// @param request ROS service request.
/// @return Interface-show options from the request fields.
InterfaceShowOptions interfaceShowOptionsFromRequest(const ros2_cli::Ros2InterfaceShow::Request& request);
...
std::string topicListRequestToJson(const ros2_cli::Ros2TopicList::Request& request, std::uint8_t timeout_sec);

/// @brief Serialize a ROS service request as a LiveKit RPC JSON payload.
/// @param request ROS service request.
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string topicPubRequestToJson(const ros2_cli::Ros2TopicPubSrv::Request& request, std::uint8_t timeout_sec);

/// @brief Serialize a ROS service request as a LiveKit RPC JSON payload.
/// @param request ROS service request.
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string serviceListRequestToJson(const ros2_cli::Ros2ServiceList::Request& request, std::uint8_t timeout_sec);
...
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string serviceCallRequestToJson(const ros2_cli::Ros2ServiceCallSrv::Request& request, std::uint8_t timeout_sec);

/// @brief Serialize a ROS service request as a LiveKit RPC JSON payload.
/// @param request ROS service request.
/// @param timeout_sec Effective timeout to include in the payload.
/// @return JSON request payload.
std::string interfaceShowRequestToJson(const ros2_cli::Ros2InterfaceShow::Request& request, std::uint8_t timeout_sec);
...
std::optional<ResponseT> cliResponseFromJson(const std::string& payload, std::string& error) {
  try {
    const auto parsed = nlohmann::json::parse(payload);
    error.clear(); // success, clear any previous error
    return makeCliResponse<ResponseT>(parsed.at("success").template get<bool>(),
