...
TopicListOptions topicListOptionsFromRequest(const Ros2TopicList::Request& request) {
...
TopicPubOptions topicPubOptionsFromRequest(const Ros2TopicPubSrv::Request& request) {
...
ServiceListOptions serviceListOptionsFromRequest(const Ros2ServiceList::Request& request) {
...
ServiceCallOptions serviceCallOptionsFromRequest(const Ros2ServiceCallSrv::Request& request) {
...
InterfaceShowOptions interfaceShowOptionsFromRequest(const Ros2InterfaceShow::Request& request) {
...
std::string topicListRequestToJson(const Ros2TopicList::Request& request, std::uint8_t timeout_sec) {
...
std::string topicPubRequestToJson(const Ros2TopicPubSrv::Request& request, std::uint8_t timeout_sec) {
...
std::string serviceListRequestToJson(const Ros2ServiceList::Request& request, std::uint8_t timeout_sec) {
...
std::string serviceCallRequestToJson(const Ros2ServiceCallSrv::Request& request, std::uint8_t timeout_sec) {
...
std::string interfaceShowRequestToJson(const Ros2InterfaceShow::Request& request, std::uint8_t timeout_sec) {
...
std::optional<ServiceCallOptions> serviceCallOptionsFromJson(const std::string& payload, std::string& error) {
  try {
    ...
    ServiceCallOptions options;
    options.service =
        ros2_cli::requiredStringField(request, "service", "service must be a string", "service must be non-empty");
    options.msg_type =
        ros2_cli::requiredStringField(request, "msg_type", "msg_type must be a string", "msg_type must be non-empty");
    options.payload =
        ros2_cli::requiredStringField(request, "payload", "payload must be a string", "payload must be non-empty");
