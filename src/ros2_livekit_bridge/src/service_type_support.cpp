...
const MessageTypeSupport::MessageMembers &MessageTypeSupport::requireMembers(
...
ServiceTypeSupport::ServiceTypeSupport(const std::string &type, std::shared_ptr<rcpputils::SharedLibrary> library,
...
std::shared_ptr<ServiceTypeSupport> ServiceTypeSupport::create(const std::string &type, std::string &error) {
  try {
