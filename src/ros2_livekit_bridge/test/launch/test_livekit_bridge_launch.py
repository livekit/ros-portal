...
LAUNCH_FILE = (
    ...
    / 'launch'
    / 'livekit_bridge.launch.py'
)


def _load_launch_module():
    spec = spec_from_file_location('livekit_bridge_launch', LAUNCH_FILE)
...
def test_launch_setup_passes_config_path(tmp_path):
    ...
    assert actions[0].kwargs['package'] == 'ros2_livekit_bridge'
    assert actions[0].kwargs['executable'] == 'ros2_livekit_bridge_node'
