...
#   eval "$(bash src/ros2_livekit_bridge/test/token_helpers/set_bridge_integration_tokens.bash)"
#
# Exports:
#   LIVEKIT_URL
#   LIVEKIT_TOKEN_A
...
_fail() {
  echo "set_bridge_integration_tokens.bash: $1" >&2
...
if [[ "$_sourced" -eq 1 ]]; then
  ...
  _emit_eval
  echo "set_bridge_integration_tokens.bash: for this shell run: source $0   or: eval \"\$(bash $0)\"" >&2
fi
