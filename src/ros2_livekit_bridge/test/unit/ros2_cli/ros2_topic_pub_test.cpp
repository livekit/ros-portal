...
protected:
  ...
  ros2_cli::Ros2TopicPub makePublisher(ros2_cli::TopicPublishAllowed allowed = {}) const {
    return ros2_cli::Ros2TopicPub(node_->get_node_topics_interface(), node_->get_node_graph_interface(),
                                  std::move(allowed));
  }
...
TEST_F(Ros2TopicPubTest, RejectsGraphTypeMismatch) {
  ...
  ASSERT_TRUE(spinUntil([&]() {
    ...
    return found != topics.end() && ros2_cli::topicTypeMatches(found->second, "std_msgs/msg/String");
  }));
