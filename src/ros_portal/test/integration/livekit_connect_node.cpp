 ...
 * core LiveKit C++ SDK directly. Its purpose is to prove that the direct SDK
 * links and functions correctly inside a ROS2 colcon build.
 *
 * Parameters:
 ...
 *   ros2 run ros_portal livekit_connect_node \
...
int main(int argc, char* argv[]) {
  ...
  try {
    rclcpp::spin(std::make_shared<ros_portal::LiveKitConnectNode>());
  } catch (const std::exception& e) {
