...
"""Generate config_parser.hpp/cpp from ros_portal_config.schema.json."""
...
// This file is generated from schema/ros_portal_config.schema.json.
// Do not edit by hand.
"""
...
class SchemaModel:
    def __init__(self, schema: dict[str, Any]) -> None:
        ...
        self.root_spec = self._build_object_spec(
            ...
            cpp_name="RosPortalConfig",
            parse_name="parseRosPortalConfig",
            depth=1)
...
def make_template_context(model: SchemaModel) -> dict[str, Any]:
    return {
        ...
        "guard": "ROS_PORTAL_CONFIG__CONFIG__CONFIG_PARSER_HPP_",
